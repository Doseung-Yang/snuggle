...
function Detail(props){
  ...
  return (
      ...
      <div className="row">
        ...
        <Carousel showThumbs={false}>
            {shoe.imageURL.map((url, index) => (
              <div key={index}>
                <img src={url} style={{width: '100%', height: '100%', objectFit: 'cover', paddingLeft: 16, paddingRight: 16, flexDirection: 'column', justifyContent: 'flex-start', alignItems: 'center', gap: 24, display: 'inline-flex'}} />
              </div>
            ))}
          </Carousel>
        </div>
        ...
        <div style={{width: 380, hegiht: 0, color: 'black', fontSize: 24, fontFamily: 'Pretendard', textAlign:"center", lineHeight: 15, wordWrap: 'break-word'}}><h4 className="pt-5">{shoe.title}</h4></div>
        <div style={{width: '100%', height: 45, justifyContent: 'space-between', alignItems: 'center', display: 'inline-flex'}}>
    ...
    <div style={{justifyContent: 'flex-start', alignItems: 'flex-start', gap: 8, display: 'flex'}}>
        <div style={{width: 150, color: '#ADB5BD', fontSize: 12, fontFamily: 'Pretendard', fontWeight: '400', lineHeight: 18, wordWrap: 'break-word'}}>진행 기간　{shoe.projectEndday}</div>
    </div>
</div>
    ...
    <div style={{display: 'flex', justifyContent: 'flex-end', width:150, color: '#ADB5BD', fontSize: '12px', fontFamily: 'Pretendard', fontWeight: '400', wordWrap: 'break-word'}}>77% 달성</div>
                </div>
            </div>
        </div>
      </div>
      <div style={{width: '100%', height: 1, position: 'relative', background: '#F2F4F6', lineHeight: 10}} /></div>
      <div style={{width: 199, hegiht: 4, color: 'black', fontSize: 24, fontFamily: 'Pretendard', textAlign:"center", lineHeight: 23, wordWrap: 'break-word'}}><h4 className="pt-5"><b>프로젝트 스토리</b></h4></div>
...
<div style={{width: '100%', height: 1, position: 'relative', background: '#F2F4F6', lineHeight: 10}} /></div>
      ...
      <div style={{width: 109, hegiht: 1, color: 'black', fontSize: 24, fontFamily: 'Pretendard', textAlign:"center", lineHeight: 10, wordWrap: 'break-word'}}><h4 className="pt-5"><b>새소식</b></h4></div>
    ...
    <div style={{alignSelf: 'stretch', color: '#ADB5BD', fontSize: 12, fontFamily: 'Pretendard', fontWeight: '300', lineHeight: 5, wordWrap: 'break-word'}}>메이커가 새소식을 준비하고 있습니다</div>
      ...
      <div style={{width: '100%', height: 1, position: 'relative', background: '#F2F4F6', lineHeight: 10}} /></div>
      <div style={{width: 109, hegiht: 1, color: 'black', fontSize: 24, fontFamily: 'Pretendard', textAlign:"center", lineHeight: 10, wordWrap: 'break-word'}}><h4 className="pt-5"><b>응원금</b></h4></div>
      <div style={{width: '100%', height: '100%', padding: 16, background: '#F9FAFB', borderRadius: 8, flexDirection: 'column', justifyContent: 'flex-start', alignItems: 'center', gap: 4, display: 'inline-flex'}}>
...
<div style={{width: 109, hegiht: 4, color: 'black', fontSize: 24, fontFamily: 'Pretendard', textAlign:"center", lineHeight: 10, wordWrap: 'break-word'}}><h4 className="pt-5"><b>응원글</b></h4></div>
<div style={{width: '100%', height: '100%', padding: 16, background: '#F9FAFB', borderRadius: 8, flexDirection: 'column', justifyContent: 'flex-start', alignItems: 'center', gap: 4, display: 'inline-flex'}}>
